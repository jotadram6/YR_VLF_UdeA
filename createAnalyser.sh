...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/work/j/jruizalv/public/VLF_ANA/YR/DAnalysis_framework/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/work/j/jruizalv/public/VLF_ANA/YR/DAnalysis_framework/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/work/j/jruizalv/public/VLF_ANA/YR/DAnalysis_framework/bin/${ananame}.cpp
